...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "94yqPP3TZubu6dHJBowQ6lmRWSq1B756T4nq_bPI";
    private static final String SECRETKEY = "-4nfogYKfWLoQSIELiEHXVffw2KGQIQMrDU_FmLf";
    private static final String BUCKET = "health3picture";
    public static final String DOMAIN= "http://qiqwgxy9r.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        //uploadFile("C:\\Users\\Administrator\\Desktop\\333.png","33333.png");
